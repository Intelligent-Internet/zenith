...
\midrule
\endhead
Product builds & \code{ii-sling-physics-game} & Internal & Build a browser game from a multi-file specification with level references and fidelity constraints. & Carry many linked gameplay, visual, physics, and content requirements across a long implementation path. \\
\rowcolor{tableband}
